...
src_coords_frac = genMinDistConstellation(src_brites,1/8,1); % source coordinates in fractional rayleigh units [x/rl]. The rayleigh length corresponds to the effective diameter
...
n_pho = 2e6;        % mean photon number                   [integer]
